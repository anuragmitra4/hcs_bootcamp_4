...
function love.update(dt)
    ...
    if snakeAlive then
        ...
        local timerLimit = 0.15 - gui.timer * 0.002; -- snake speed
        if timer >= timerLimit then
            ...
            if canMove then
                ...
                and snakeSegments[1].y == foodPosition.y then
                    moveFood();
                    Score = Score + 1;
                    -- in order to get random colors
                    red = love.math.random();
                    green = love.math.random();
                    blue = love.math.random();
                else
                    table.remove(snakeSegments);
                end
            else
...
function love.draw()
    ...
    love.graphics.setColor(red, green, blue); -- food colour
...
function drawGUI()
  ...
  love.graphics.print("Best Score: " .. tostring(HighScore), 450, 425);
